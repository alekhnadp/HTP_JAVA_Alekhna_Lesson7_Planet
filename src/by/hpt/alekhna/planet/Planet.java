...
/*Ìåòîäû: âûâåñòè íà êîíñîëü íàçâàíèå ìàòåðèêà, ïëàíåòû, êîëè÷åñòâî ìàòå-
ðèêîâ.
âûâåñòè íàçâàíèå ïëàíåòû, âñþ èíôó î ìàòåðèêàõ ýòîé ïëààíåòû, 
ìåòîä - âûâåñòè ïî íàçâàíèþ ìàòåðèêà
 âñå ñòðàíû íà íåì, ïëàùàòü, íàñåëíèèå...
 äîáàâèòü íîâûé ìàòåðèê, ñîçäàòü íîâóþ ñòðàíó íà ìàòåðèêå, */
public class Planet {
	...
	public void structOfEarth(int age) {
		if (age < 100000 && age > 530) {
			...
			islands[0] = new Island("íåáûëî òàì îñòðîâîâ");
			oceans = new Ocean[1];
			oceans[0] = new Ocean("Pantalass", 579569679L, 20, islands);
